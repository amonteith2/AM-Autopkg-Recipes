...
"""See docstring for RStudioVersioner class"""
...
class RStudioVersioner(DmgMounter):
    ...
    def main(self):
        ...
        try:
            ...
            self.env["version"] = plist.get(version_key, UNKNOWN_VERSION).replace("+", "-")
            self.output(
